...
class UCB1(object):
    ...
    def update_matrix(self, prediction, matrix_valid, matrix_input, result, matrix_input_with_negative):
        start_time = time.time()
        ...
        print("Elapsed: {0}".format(inhour(time.time() - start_time)))
        return result, matrix_input, matrix_valid, matrix_input_with_negative, chosen_arms_row, chosen_arms_col, immediate_reward
...
def ucb1(matrix_train, matrix_valid, topk, total_steps,
    ...
    for i in range(total_steps):
        ...
        normalized_pdf = ucb_selection.get_normalized_pdf(item_gaussian_mu, user_gaussian_mu, user_gaussian_sigma)
        ...
        result, matrix_input, matrix_valid, chosen_arms_row, chosen_arms_col, immediate_reward = ucb_selection.update_matrix(prediction, matrix_valid, matrix_input, result)
